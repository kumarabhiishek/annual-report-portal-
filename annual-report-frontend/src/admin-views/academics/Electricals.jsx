...
const printReport = () => {
  ...
  printWindow.document.write(`
    ...
    <html>
      ...
      <body>
        <div class="header">
          <h1 style="color: #1e3a8a; margin-bottom: 5px; font-size: 28px;">Department of Electrical</h1>
          ...
          " onClick={(e) => e.stopPropagation()}>
            ...
            <div ref={reportRef} className="p-6 space-y-8 bg-gradient-to-br from-blue-900 to-indigo-800">
              <div className="text-center mb-8">
                <h1 className="text-4xl font-bold text-white mb-2">Department of Electrical</h1>
